...
uchar lhcaBackward();
uchar lhcaForward();
uchar lhcaInitialize(ucharP state);
uchar lhcaOne();
uchar lhcaTwo();
uchar lhcaThree();
uchar lhcaFour();
...
-(uchar) initialize{state=ucharArrayNew(8); lhcaInitialize(state);[self seed:'1':'2':'2':'7':'1':'9':'7':'6'];return 0;}
...
-(uchar) seed: (uchar) one : (uchar) two : (uchar) three : (uchar) four : (uchar) five : (uchar) six : (uchar) seven : (uchar) eight{return lhcaSeed(one,two,three,four,five,six,seven,eight);}
@end
